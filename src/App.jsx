...
import LeadEnrichmentConfigPage from './pages/LeadEnrichmentConfigPage'
import ApiDocPage from './pages/ApiDocPage'
import LioConfigPage from './pages/LioConfigPage'
...
function getStoredAuth() {
  try {
    ...
    const user = JSON.parse(localStorage.getItem('wb_ai_user') || '{}')
    return { token, user }
  } catch {
    return null
  }

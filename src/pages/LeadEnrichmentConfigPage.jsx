...
const API = import.meta.env.VITE_BACKEND_URL || 'http://localhost:8020'
...
const GROQ_MODELS = [
  {
    ...
    badge:       '🏆 Best for deep analysis',
    badgeColor:  '#f59e0b',
    description: 'Chain-of-thought reasoning model. Best for structured, deep-dive lead analysis and complex scoring.',
  },
  {
    id:          'llama-3.3-70b-versatile',
    label:       'Llama 3.3 70B Versatile',
    badge:       '⭐ Recommended general',
    badgeColor:  '#6366f1',
    description: 'Best overall balance of speed + quality for outreach generation and lead summaries.',
  },
  {
    id:          'llama-3.1-70b-versatile',
    label:       'Llama 3.1 70B (128k context)',
    badge:       '📄 Long context',
    badgeColor:  '#10b981',
    description: '128k token context window — ideal for analyzing very large lead profiles with rich activity data.',
  },
  {
    ...
    badge:       '⚡ Fastest',
    badgeColor:  '#8b5cf6',
    description: 'Ultra-fast responses (~0.5s). Good for quick summaries when speed matters more than depth.',
  },
  {
    ...
    badge:       'MoE',
    badgeColor:  '#64748b',
    description: 'Mixture-of-Experts model with 32k context. Good multilingual support.',
  },
]
